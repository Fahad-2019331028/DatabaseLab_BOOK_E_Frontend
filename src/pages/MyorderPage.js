      ...
      <main className="body5">
        ...
        <div className="book-sec2">
          ...
          <div className="pagination">
           ...
           {/* <div className="book12">
            <img className="book-pic-icon12" alt="" src="/book-pic@2x.png" />
            <h2 className="title12">Title</h2>
            <h4 className="author12">Author</h4>
            <div className="gnre12">
              <div className="genre24">Genre</div>
              <div className="genre25">#Genre</div>
            </div>
            <div className="gnre12">
              <div className="condition37">Condition</div>
              <div className="condition38">#condition</div>
            </div>
            <div className="gnre12">
              <div className="condition37">Book Type</div>
              <div className="condition38">#book typ</div>
            </div>
            <div className="status6">
              <div className="order-status12">{`Order Status `}</div>
              <div className="order-status13">{`Order Status `}</div>
            </div>
            <a className="viewbook-link12">
              <div className="frame12">
                <div className="frame-child9" />
                <div className="frame-wrapper9">
                  <img className="frame-icon12" alt="" src="/frame4.svg" />
                </div>
              </div>
              <div className="view-book12">View Book.......</div>
            </a>
          </div> <div className="book12">
            <img className="book-pic-icon12" alt="" src="/book-pic@2x.png" />
            <h2 className="title12">Title</h2>
            <h4 className="author12">Author</h4>
            <div className="gnre12">
          ...
          <div className="book12">
            ...
            <a className="viewbook-link12">
              <div className="frame12">
                <div className="frame-child9" />
                <div className="frame-wrapper9">
                  <img className="frame-icon12" alt="" src="/frame5.svg" />
                </div>
              </div>
              <div className="view-book12">View Book.......</div>
            </a>
